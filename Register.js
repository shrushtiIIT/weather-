...
import {
  ...
  Box,
  Alert,
  // This is the Material-UI Link component
  Link
} from '@mui/material';
    ...
    <Container maxWidth="sm">
      <Box sx={{ mt: 8, mb: 4 }}>
        <Paper elevation={3} sx={{ p: 4 }}>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 1, opacity: success ? 0.5 : 1 }}>
            <TextField
              margin="normal"
              required
              fullWidth
            ...
            <Box sx={{ textAlign: 'center' }}>
              {/* FIX: Replaced the standard Link with the RouterLink for SPA navigation */}
